...
function calculateLeagueTable(rows, season) {
    ...
    rows.forEach(row => {
        ...
        if (!table[home]) table[home] = { team: home, played: 0, won: 0, draw: 0, lost: 0, goalsFor: 0, goalsAgainst: 0, points: 0 };
        if (!table[visitor]) table[visitor] = { team: visitor, played: 0, won: 0, draw: 0, lost: 0, goalsFor: 0, goalsAgainst: 0, points: 0 };
    ...
    if (tieBreaker === 'goalAverage') {
        leagueArray.sort((a, b) =>
            b.points - a.points || b.goalAverage - a.goalAverage || b.goalsFor - a.goalsFor
        );
    } else {
        leagueArray.sort((a, b) =>
...
const tier1Files = fs.readdirSync(tier1Dir)
